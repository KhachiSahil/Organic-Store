...
export default function SignIn() {
  ...
  const handleSubmit = async (e:any) => {
    ...
    // For example, you can call an API to authenticate the user with credentials
      ...
      <div className="flex justify-center h-screen align-middle items-center bg-transparent">
        <div className="flex flex-col border-2 border-slate-300 shadow-2xl rounded-lg gap-8 items-center p-10 bg-slate-100">
          ...
          <button
            ...
            className="flex shadow-xl gap-3 bg-lime-400 py-2 px-5 rounded-md text-white font-semibold hover:bg-lime-700"
          >
            Signin with
            <span>
              <svg
